...
public class QueryExecutor extends DbConnector {
    ...
    static int numOfRows=0;//to save number of added rows
   ...
   public static void insertRow(){
    ...
    public static void deleteRow(){
        ...
        try{
            ...
            if (Others.bSe(tab,num)) {
                ...
                System.out.println("The word with the given word_ID does not exist");}
        }catch (SQLException e){
            e.printStackTrace();
        }
    }//deleteRow
    ...
    try {
        ResultSet result = QueryExecutor.executeSelect("SELECT * FROM");
        while (result.next()) {
